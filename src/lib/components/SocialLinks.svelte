<script>
	...
	import duneLogo from '$lib/images/dune.svg';
</script>

<div class="flex flex-row gap-4">
	<a href="https://x.com/hyperionsol_" target="_blank">
		<img src={xLogo} alt="x" class="h-4 w-4 sm:h-5 sm:w-5" />
	</a>
	<a href="https://t.me/hyperionfi" target="_blank">
	...
	<a href="https://dune.com/hyperionfinance" target="_blank">
		<img src={duneLogo} alt="dune" class="h-4 w-4 sm:h-5 sm:w-5" />
	</a>
</div>

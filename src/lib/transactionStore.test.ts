...
describe('transactionStore', () => {
	...
	it('should prompt the user to approve hySOL contract to lock mSOL if allowance is less than assets', async () => {
		...
		awaitWalletConfirmation('You need to approve the hySOL contract to lock your SSOL...');

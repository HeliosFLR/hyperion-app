...
const mockHySOLAddressWritable = writable<Hex>('0x91e3B9820b47c7D4e6765E90F94C1638E7bc53C6');
const mockSOLAddressWritable = writable<Hex>('0x91e3B9820b47c7D4e6765E90F94C163123456789');
...
export const mockHySOLAddressStore = {
	subscribe: mockHySOLAddressWritable.subscribe,
	set: mockHySOLAddressWritable.set,
	mockSetSubscribeValue: (value: Hex): void => mockHySOLAddressWritable.set(value)
};

export const mockSOLAddressStore = {
	subscribe: mockSOLAddressWritable.subscribe,
	set: mockSOLAddressWritable.set,
	mockSetSubscribeValue: (value: Hex): void => mockSOLAddressWritable.set(value)
};

...
export const SOLAddress = writable<Hex>('0x1D80c49BbBCd1C0911346656B529DF9E5c2F783d');
...
export const targetNetwork = writable<Chain>(solana);
...
export const tokens: CyToken[] = [
	{
		...
		underlyingAddress: '0x12e605bc104e93B45e1aD99F9e555f659051c2BB' as Hex, // SOL

export enum TransactionErrorMessage {
	...
	LOCK_FAILED = 'There was an error in the lock transaction, and it failed to lock your mSOL. Please see the block explorer link for more information.',
	UNLOCK_FAILED = 'There was an error unlocking your mSOL. Please see the block explorer link for more information.',
	APPROVAL_FAILED = 'There was an error in the approval transaction, and it failed to approve the hySOL spend. Please see the block explorer link for more information.',
